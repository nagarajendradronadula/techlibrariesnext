  ...
  return (
    <div>
      <Link
        ...
        className={`w-32 h-32 sm:w-36 sm:h-36 md:w-40 md:h-40 lg:w-44 lg:h-44 xl:w-48 xl:h-48 ${className}`}
      >
        <img
          src={languageLogo}
          alt={languageName}
        ...
        ></img>
        <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-semibold m-1 sm:m-2 md:m-3 lg:m-4">{languageName}</p>
      </Link>
    </div>
  );
}
